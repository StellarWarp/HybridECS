...
void test()
{
    ...
    auto static_lambda_h = a->event_ret.bind([](ARG_LIST)
                                             {
                                                 std::cout << "stateless callable" << std::endl;
                                                 return 0;
                                             });
    ...
    {
        auto h1 = a->event_default.bind<&C::action>(c);
        auto h2 = a->event_default.bind(c, [](auto&& o, ARG_LIST) { o.action(ARG_LIST_FORWARD); });

        a->event_default.invoke(params.v1, params.v2, params.v1, params.v2);
    }
    a->event_default.invoke(params.v1, params.v2, params.v1, params.v2);
