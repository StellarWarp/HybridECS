...
if __name__ == "__main__":
    ...
    parser.add_argument('command', choices=['add', 'pull', 'push', 'pull-all'], help="Command to run: add, pull, push, or pull-all")
    parser.add_argument('name', nargs='?', help="The name of the subtree (as defined in the config file)")
    parser.add_argument('--config', default='subtrees.json', help="The path to the configuration file (default: subtrees.json)")
